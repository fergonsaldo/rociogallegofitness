...
export default function CreateVideoScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (result) {
      Alert.alert('✓', Strings.videoFormSuccess, [{ text: 'OK', onPress: () => router.back() }]);
    }
  };
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>{Strings.videoFormTitle}</Text>
        ...
        >
          {isCreating
            ...
            : <Text style={styles.submitButtonText}>{Strings.videoFormSubmit}</Text>
          }
        </TouchableOpacity>
