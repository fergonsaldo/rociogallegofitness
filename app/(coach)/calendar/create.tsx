...
export default function CreateSessionScreen() {
  ...
  const [athleteName,     setAthleteName]     = useState<string>(Strings.sessionFormAthleteNone);
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{Strings.sessionFormTitle}</Text>
        <View style={{ width: 40 }} />
      </View>
        ...
        <View style={styles.form}>
          ...
          >
            {isSubmitting
              ...
              : <Text style={styles.submitBtnText}>{Strings.sessionFormSubmit}</Text>
            }
          </TouchableOpacity>
