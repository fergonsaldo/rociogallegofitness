...
const styles = StyleSheet.create({
  ...
  backText:         { fontSize: 28, color: Colors.athlete, lineHeight: 32 },
  headerInfo:       { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, flex: 1 },
  headerAvatar:     { width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.athleteSubtle, alignItems: 'center', justifyContent: 'center' },
  headerAvatarText: { fontSize: FontSize.md, fontWeight: '700', color: Colors.athlete },
  ...
  bubbleOwn:        { backgroundColor: Colors.athlete, borderBottomRightRadius: 4 },
  ...
  sendBtn:          { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.athlete, alignItems: 'center', justifyContent: 'center' },
