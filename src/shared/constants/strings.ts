...
export const Strings = {
  ...
  sessionFormNoTypes:     'Sin tipos — crea uno desde ⚙️',
  ...
  // ── Automatizaciones por etiqueta (RF-E2-06) ─────────────────────────────────
  tagAutomationTitle:           'Automatización',
  tagAutomationSubtitle:        (name: string) => `Etiqueta: ${name}`,
  tagAutomationDescription:     'Al asignar esta etiqueta a un atleta, el contenido seleccionado se asignará automáticamente.',
  tagAutomationSectionRoutine:  'Rutina',
  tagAutomationSectionCardio:   'Cardio',
  tagAutomationSectionNutrition:'Plan de nutrición',
  tagAutomationNone:            'Sin asignar',
  tagAutomationSelectRoutine:   'Seleccionar rutina',
  tagAutomationSelectCardio:    'Seleccionar cardio',
  tagAutomationSelectNutrition: 'Seleccionar plan',
  tagAutomationSave:            'Guardar automatización',
  tagAutomationDelete:          'Eliminar automatización',
  tagAutomationDeleteConfirm:   '¿Eliminar la automatización de esta etiqueta?',
  tagAutomationDeleteCancel:    'Cancelar',
  tagAutomationDeleteOk:        'Eliminar',
  tagAutomationSaveSuccess:     'Automatización guardada',
  tagAutomationDeleteSuccess:   'Automatización eliminada',
  tagAutomationPickerDone:      'Listo',
  tagAutomationEmpty:           'Sin elementos disponibles',
  tagAutomationPickerClear:     'Sin asignar',
  tagHasAutomation:             'Automatización activa',
  tagAutomationAlertTitle:      'Automatización parcial',
  tagAutomationAlertMessage:    'La etiqueta se ha asignado, pero alguna asignación de contenido automática ha fallado. Revisa la configuración.',

  // ── Grupos de atletas (RF-E2-04) ─────────────────────────────────────────────
  groupsTitle:              'Grupos',
  groupsSubtitle:           (n: number) => `${n} ${n === 1 ? 'grupo' : 'grupos'}`,
  groupsNewButton:          '+ Nuevo grupo',
  groupsEmpty:              'Sin grupos todavía',
  groupsEmptySubtitle:      'Crea un grupo para asignar contenido a varios atletas a la vez',
  groupMembers:             (n: number) => `${n} ${n === 1 ? 'atleta' : 'atletas'}`,
  groupFormCreateTitle:     'Nuevo grupo',
  groupFormEditTitle:       'Editar grupo',
  groupFormNameLabel:       'Nombre',
  groupFormNamePlaceholder: 'Ej. Principiantes enero, Avanzados...',
  groupFormDescLabel:       'Descripción (opcional)',
  groupFormDescPlaceholder: 'Para qué sirve este grupo...',
  groupFormSubmitCreate:    'Crear grupo',
  groupFormSubmitEdit:      'Guardar cambios',
  groupFormCancel:          'Cancelar',
  groupDetailTitle:         'Detalle de grupo',
  groupDetailMembers:       'Miembros',
  groupDetailAddMembers:    '+ Añadir atletas',
  groupDetailEmpty:         'Sin miembros',
  groupDetailEmptySubtitle: 'Añade atletas a este grupo',
  groupDetailRemove:        'Quitar del grupo',
  groupDeleteTitle:         'Eliminar grupo',
  groupDeleteMessage:       (name: string) => `¿Eliminar el grupo "${name}"? Se eliminará el grupo y sus miembros, pero el contenido asignado a los atletas no se verá afectado.`,
  groupDeleteCancel:        'Cancelar',
  groupDeleteConfirm:       'Eliminar',
