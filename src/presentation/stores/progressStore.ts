...
export const useProgressStore = create<ProgressState>((set) => ({
  ...
  fetchHistory: async (athleteId) => {
    ...
    try {
      ...
      set({ error: err instanceof Error ? err.message : 'Failed to load history', historyLoading: false });
    }
  },
  ...
  fetchProgression: async (athleteId, exerciseId) => {
    ...
    try {
      ...
      set({ error: err instanceof Error ? err.message : 'Failed to load progression', progressionLoading: false });
    }
  },
  ...
  fetchPersonalBests: async (athleteId) => {
    ...
    try {
      ...
      set({ error: err instanceof Error ? err.message : 'Failed to load personal bests', personalBestsLoading: false });
    }
  },
